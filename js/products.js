/**
 * Arabian Perfume Lab — Complete Product Catalogue
 *
 ...
 *   sizes       {object}  { "50ml": price, "100ml": price } — prices from products.js only
 ...
 *   celebrity   {string}  For celebrity collection — celebrity name
 *   inspiration {string}  For celebrity collection — fragrance reference
 *
 * ╔══════════════════════════════════════════════╗
 * ║        REAL BUSINESS PRICING                ║
 * ╠══════════════════════════════════════════════╣
 * ║  Attars          starting ₹100              ║
 * ║  Solid Perfumes  starting ₹99               ║
 * ║  20ml Perfume    ₹333 (3 for ₹999)          ║
 * ║  50ml Perfume    starting ₹499              ║
 * ║  50ml × 2 Bundle ₹999                       ║
 * ║  100ml Perfume   starting ₹999              ║
 * ╚══════════════════════════════════════════════╝
 *
 * Image styles (local SVGs, Arabian bottle designs):
 *   bottle-amber.svg   — golden/amber liquid  → masculine, oud, spicy
 *   bottle-blue.svg    — blue liquid          → aquatic, fresh, sporty
 *   bottle-rose.svg    — rose/pink liquid     → feminine, floral
 *   bottle-light.svg   — pale/clear liquid    → fresh, light, unisex
 *   bottle-premium.svg — dark glass           → niche, premium, intense
...
/* -------------------------------------------------------
   PRICING CONSTANTS — edit here to change default prices
...
const products = Object.freeze([
       ...
       =========================================================== */
    {
        ...
        description: 'Bold and raw, a fresh-fougère built on bergamot, Sichuan pepper, and ambroxan. Inspired by Dior Sauvage.',
        badge: 'BESTSELLER'
    },
    {
        id: 'dior-sauvage-edp', brand: 'Dior', name: 'Sauvage EDP',
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Dior Sauvage EDP',
        notes: ['Fresh', 'Woody', 'Vanilla'],
        description: 'Richer and warmer than the EDT — lavender and vanilla deepen the rugged bergamot opening. Inspired by Dior Sauvage EDP.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Miss Dior",
        notes: ['Floral', 'Rose', 'Fresh'],
        description: 'A sparkling chypre of Grasse rose, patchouli, and citrus — feminine elegance distilled. Inspired by Miss Dior.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Joy by Dior',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Tom Ford Lost Cherry',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Tom Ford Rose Prick',
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Bleu de Chanel',
        notes: ['Woody', 'Aromatic', 'Fresh'],
        description: 'Citrus, labdanum, sandalwood, and incense — the urbane fragrance for the modern man. Inspired by Bleu de Chanel EDT.',
        badge: 'BESTSELLER'
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Bleu de Chanel EDP',
        notes: ['Woody', 'Aromatic', 'Amber'],
        description: 'Deeper and richer than the EDT — ginger and labdanum add warmth to the iconic accord. Inspired by Bleu de Chanel EDP.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Chanel No.5',
        notes: ['Floral', 'Powdery', 'Aldehyde'],
        description: 'The world\'s most iconic fragrance — aldehydes, ylang-ylang, rose, jasmine, and sandalwood. Inspired by Chanel No.5.',
        badge: 'ICONIC'
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Coco Mademoiselle',
        notes: ['Floral', 'Oriental', 'Citrus'],
        description: 'Orange, rose, and jasmine on patchouli and vanilla — timeless feminine chic. Inspired by Coco Mademoiselle.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Allure Homme Sport',
        notes: ['Fresh', 'Citrus', 'Woody'],
        description: 'Sea notes, citrus, and white musk — clean, sporty, and effortlessly stylish. Inspired by Allure Homme Sport.',
        badge: ''
    },
    {
       ...
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Creed Aventus inspired bottle with Arabic tile art label',
        notes: ['Fruity', 'Woody', 'Smoky'],
        description: 'Pineapple, blackcurrant, birch, and oakmoss — the scent of success and strength. Inspired by Creed Aventus.',
        badge: 'ICONIC'
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Creed Vikings inspired bottle with cricket silhouette red label',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Creed Silver Mountain Water',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Creed Love in White',
        notes: ['Floral', 'Rice', 'Musk'],
        description: 'Rice, iris, magnolia and white musk — a purity and radiance for women. Inspired by Creed Love in White.',
        badge: ''
    },
    ...
    /* ===========================================================
       ...
       =========================================================== */
    {
        id: 'armani-acqua-di-gio', brand: 'Armani', name: 'Acqua di Giò',
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Acqua di Giò',
        notes: ['Aquatic', 'Citrus', 'Woody'],
        description: 'Sea notes, bergamot, and rosemary on a white musk drydown — the definitive aquatic fragrance. Inspired by Acqua di Giò.',
        badge: 'BESTSELLER'
    },
    {
    ...
    {
        id: 'armani-si', brand: 'Armani', name: 'Sì',
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Armani Sì',
        notes: ['Floral', 'Chypre', 'Musk'],
        description: 'Blackcurrant, rose, and freesia on a warm patchouli and vanilla base. Inspired by Armani Sì.',
        badge: ''
    },
    {
        id: 'armani-si-passione', brand: 'Armani', name: 'Sì Passione',
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Armani Sì Passione',
        notes: ['Floral', 'Fruity', 'Woody'],
        description: 'Rose, peony, and peach over musk and patchouli — vibrant feminine intensity. Inspired by Armani Sì Passione.',
        badge: ''
    },
    {
        ...
        description: 'Chestnut, cardamom, and vanilla — warmth and strength combined. Inspired by Armani Stronger With You.',
        badge: 'POPULAR'
    },
    ...
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Byredo Rose of No Man's Land",
        notes: ['Rose', 'Floral', 'Papyrus'],
        description: 'Turkish rose petals, raspberry blossom, and papyrus — delicate and powerful at once. Inspired by Rose of No Man\'s Land.',
        badge: ''
    },
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Paco Rabanne Invictus',
        notes: ['Aquatic', 'Fresh', 'Woody'],
        description: 'Grapefruit, sea notes, and guaiac wood — triumphant, unstoppable freshness. Inspired by Invictus.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Paco Rabanne Lady Million',
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Davidoff Cool Water',
        notes: ['Aquatic', 'Fresh', 'Woody'],
        description: 'Mint, green nuances, and oakmoss — the original aquatic freshness. Inspired by Cool Water.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Davidoff Cool Water Women',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Azzaro Chrome',
        notes: ['Citrus', 'Aquatic', 'Woody'],
        description: 'Bergamot, rosemary, and oakmoss — a timeless fresh-aromatic classic. Inspired by Azzaro Chrome.',
        badge: ''
    },
    {
        ...
        notes: ['Spicy', 'Amber', 'Woody'],
        description: 'Cardamom, juniper berry, and coumarin — the fragrance of audacity and style. Inspired by Azzaro Most Wanted.',
        badge: 'POPULAR'
    },
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Bvlgari Aqva',
        notes: ['Aquatic', 'Citrus', 'Fresh'],
        description: 'Posidonia, trident marine accord, and amber wood — deep sea freshness. Inspired by Bvlgari Aqva.',
        badge: ''
    },
    {
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — D&G Light Blue',
        notes: ['Citrus', 'Floral', 'Woody'],
        description: 'Sicilian lemon, apple, cedar, and white rose — Mediterranean summer in a bottle. Inspired by Light Blue.',
        badge: 'BESTSELLER'
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — D&G Light Blue Men',
        notes: ['Citrus', 'Aquatic', 'Woody'],
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — D&G Light Blue Intense',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — D&G Queen',
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Versace Eros',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Versace Dylan Blue',
        notes: ['Aquatic', 'Fougère', 'Woody'],
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Versace Bright Crystal',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — YSL Y EDP',
        notes: ['Fruity', 'Spicy', 'Woody'],
        description: 'Apple, ginger, and sage over ambergris — bold and contemporary. Inspired by YSL Y EDP.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — YSL Libre',
        notes: ['Floral', 'Lavender', 'Musk'],
        description: 'Lavender, mandarin, and jasmine on warm musk — freedom and femininity. Inspired by Libre.',
        badge: ''
    },
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — CK Euphoria',
    ...
    {
        id: 'hermes-twilly', brand: 'Hermes', name: "Twilly d'Hermès",
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Twilly d'Hermès",
        notes: ['Floral', 'Ginger', 'Tuberose'],
        description: 'Ginger, tuberose, and sandalwood — fresh young femininity. Inspired by Twilly d\'Hermès.',
        badge: ''
    },
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: "Arabian Perfume Lab inspired bottle — L'Eau d'Issey",
        notes: ['Aquatic', 'Fresh', 'Woody'],
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Prada Luna Rossa',
        notes: ['Aquatic', 'Herbal', 'Woody'],
        description: 'Labdanum, lavender, and ambrette — sporty aromatic elegance. Inspired by Luna Rossa.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Prada Candy',
        notes: ['Sweet', 'Musk', 'Vanilla'],
        description: 'Caramel, benzoin, and musk — playful sweetness with sophistication. Inspired by Prada Candy.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Gucci Guilty Women',
        notes: ['Floral', 'Citrus', 'Woody'],
        description: 'Pink pepper, lilac, and amber — rebellious feminine charm. Inspired by Gucci Guilty Women.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Gucci Bloom',
        notes: ['Floral', 'White Flowers', 'Tuberose'],
        description: 'Tuberose, Rangoon creeper, and jasmine — a garden in full bloom. Inspired by Gucci Bloom.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Rasasi Hawas',
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Mont Blanc Legend',
        notes: ['Fougère', 'Woody', 'Fresh'],
        description: 'Bergamot, lavender, and oakmoss — a reliable, elegant fougère. Inspired by Legend.',
        badge: ''
    },
    {
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — JPG Le Male',
        notes: ['Lavender', 'Vanilla', 'Mint'],
        description: 'Lavender, vanilla, and mint — iconic masculine contrast. Inspired by Le Male.',
        badge: 'ICONIC'
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — JPG Scandal',
       ...
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Tam Dao inspired bottle, black and white minimalist label, 50ml',
        notes: ['Sandalwood', 'Cedar', 'Woody'],
        description: 'Pure sandalwood, cypress, and white musk — serene and temple-like. Inspired by Tam Dao.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Diptyque Do Son',
        notes: ['Tuberose', 'Floral', 'Musk'],
        description: 'Tuberose and musky white flowers — the scent of a Vietnamese bay. Inspired by Do Son.',
        badge: ''
    },
    {
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Boss Alive',
        notes: ['Floral', 'Fruity', 'Woody'],
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Victoria's Secret Bombshell",
        notes: ['Floral', 'Citrus', 'Fruity'],
        description: 'Purple passion fruit, vanilla orchid, and musk — gorgeous and playful. Inspired by Bombshell.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Victoria's Secret Love Spell",
        notes: ['Fruity', 'Floral', 'Musk'],
        description: 'Cherry blossom, peach, and white musk — young, fresh, and romantic. Inspired by Love Spell.',
        badge: ''
    },
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Ralph Lauren Polo Sports',
        notes: ['Aquatic', 'Citrus', 'Fresh'],
        description: 'Sea notes, bergamot, and cedar — classic sporty freshness. Inspired by Polo Sports.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Ralph Lauren Polo Blue',
        notes: ['Aquatic', 'Cucumber', 'Woody'],
        description: 'Melon, cucumber, and suede on a woody musk — laid-back luxury. Inspired by Polo Blue.',
        badge: ''
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Ralph Lauren Ralph',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Jo Malone Peony & Blush Suede',
    ...
    },
    {
        ...
        collection: 'standard', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab inspired bottle — Kilian Love Don't Be Shy",
        notes: ['Sweet', 'Musk', 'Marshmallow'],
        description: 'Orange blossom, neroli, and marshmallow musk — addictively sweet and sensual. Inspired by Love Don\'t Be Shy.',
        badge: ''
    },
    ...
    },
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Parfums de Marly Delina',
        notes: ['Rose', 'Rhubarb', 'Musk'],
        description: 'Turkish rose, rhubarb, and cashmere musk — feminine, radiant, and modern. Inspired by Delina.',
        badge: 'BESTSELLER'
    },
       ...
       =========================================================== */
    {
        ...
        collection: 'standard', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab inspired bottle — Viktor & Rolf Flowerbomb',
    ...
    /* ===========================================================
       PREMIUM EDP COLLECTION (100ml = ₹1,799)
       =========================================================== */
    {
    ...
    },
    {
        ...
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Le Labo Rose 31',
        notes: ['Rose', 'Woody', 'Spicy'],
        description: 'Rose deconstructed with cumin, cedar, and vetiver — androgynous rose masterpiece. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    {
        id: 'premium-tomford-cafe-rose', brand: 'Tom Ford', name: 'Café Rose (Premium EDP)',
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Tom Ford Café Rose',
    ...
    },
    {
        ...
        collection: 'premium', gender: 'men',
        sizes: PRM, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Tom Ford Bleu de Jour',
        notes: ['Aquatic', 'Citrus', 'Woody'],
        description: 'Citrus, aquatic notes, and oakwood — a refined Mediterranean freshness. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    },
    {
        ...
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Mancera Instant Crush',
        notes: ['Rose', 'Musk', 'Amber'],
        description: 'Rose, bergamot, and sandalwood — elegantly addictive. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
        ...
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Mancera Rose Vanilla',
        notes: ['Rose', 'Vanilla', 'Amber'],
        description: 'Turkish rose and Madagascar vanilla — an unapologetically sensual romance. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
        id: 'premium-ga-acqua-gio-essenza', brand: 'Armani', name: 'Acqua di Giò Essenza (Premium EDP)',
        collection: 'premium', gender: 'men',
        sizes: PRM, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Acqua di Giò Essenza',
        notes: ['Aquatic', 'Woody', 'Amber'],
        description: 'Citrus, incense, and patchouli — deeper aquatic elegance. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    {
        id: 'premium-fm-portrait-lady', brand: 'Frédéric Malle', name: 'Portrait of a Lady (Premium EDP)',
        collection: 'premium', gender: 'women',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Portrait of a Lady',
        notes: ['Rose', 'Patchouli', 'Raspberry'],
        description: 'Turkish rose, patchouli, and sandalwood — an overwhelming feminine masterpiece. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    {
        id: 'premium-fm-rose-cuir', brand: 'Frédéric Malle', name: 'Rose & Cuir (Premium EDP)',
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Frédéric Malle Rose & Cuir',
        notes: ['Rose', 'Leather', 'Woody'],
        description: 'Rose absolute with dark leather and birchwood — a love story. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    },
    {
        ...
        collection: 'premium', gender: 'unisex',
        sizes: PRM, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab Premium EDP — Xerjoff 40 Knots',
        notes: ['Aquatic', 'Woody', 'Citrus'],
        description: 'Sea breeze, driftwood, and white musk — luxury yachting in a bottle. Premium inspired EDP.',
        badge: 'PREMIUM'
    },
    {
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'men',
        sizes: STD, image: IMG.tamDaoSrk,
        imageAlt: 'Arabian Perfumer\'s — Tam Dao SRK inspired bottle, black and white Diptyque label, 50ml',
        notes: ['Sandalwood', 'Cedar', 'Woody'],
        description: 'Serene sandalwood and cypress — reportedly a favourite of Shah Rukh Khan. Inspired by Diptyque Tam Dao.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        description: 'Bergamot, green apple, and cedarwood — a fresh, confident scent inspired by the Cristiano Ronaldo signature style.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Esha Gupta style',
        notes: ['Floral', 'Citrus', 'Musk'],
        description: 'Citrus blossom and peony on a sandalwood base — reported favourite of Esha Gupta. Inspired by Gucci Flora.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        notes: ['Spicy', 'Woody', 'Fresh'],
        description: 'Pink pepper, lavender, and sandalwood — power and passion. Inspired by Creed Viking.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'unisex',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Alia Bhatt style',
        notes: ['Woody', 'Aromatic', 'Fresh'],
        description: 'Citrus and labdanum on sandalwood — reportedly favoured by Alia Bhatt. Inspired by Bleu de Chanel.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Sara Ali Khan style',
        notes: ['Floral', 'Powdery', 'Aldehyde'],
        description: 'Aldehydes, rose, and jasmine — the world\'s most iconic fragrance profile. Inspired by Chanel No.5.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        inspiration: 'Tom Ford Ombré Leather'
    },
    {
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'women',
        sizes: STD, image: IMG.rose,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Aditi Rao Hydari style',
        notes: ['Floral', 'White Flowers', 'Tuberose'],
        description: 'Tuberose, jasmine, and Rangoon creeper — a garden in full bloom. Inspired by Gucci Bloom.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Ranbir Kapoor style',
        notes: ['Lavender', 'Vanilla', 'Mint'],
        description: 'Lavender and vanilla contrast — iconic bold masculinity. Inspired by JPG Le Male.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Akshay Kumar style',
        notes: ['Aquatic', 'Fresh', 'Woody'],
        description: 'Mint, green accords, and oakmoss — the original refreshing aquatic. Inspired by Cool Water.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'men',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Saif Ali Khan & Tiger Shroff style',
        notes: ['Fresh', 'Citrus', 'Woody'],
        description: 'Sea notes and white musk — athletic and elegant. Inspired by Allure Homme Sport.',
        badge: 'CELEBRITY INSPIRED',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'unisex',
        sizes: STD, image: IMG.rose,
        imageAlt: "Arabian Perfume Lab celebrity inspired bottle — Hrithik Roshan Byredo style",
        notes: ['Rose', 'Floral', 'Papyrus'],
        description: 'Turkish rose and raspberry blossom — delicate, powerful, and unexpected. Inspired by Byredo Rose of No Man\'s Land.',
        badge: 'CELEBRITY INSPIRED',
        celebrity: 'Hrithik Roshan',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'women',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Esha Gupta Versace style',
        notes: ['Aquatic', 'Fougère', 'Woody'],
        description: 'Aquozone and violet — the feminine version of Italian freshness. Inspired by Versace Dylan Blue.',
        badge: 'CELEBRITY INSPIRED',
        celebrity: 'Esha Gupta',
    ...
    },
    {
        ...
        collection: 'celebrity', gender: 'women',
        sizes: STD, image: IMG.blue,
        imageAlt: 'Arabian Perfume Lab celebrity inspired bottle — Anushka Sharma style',
        notes: ['Citrus', 'Floral', 'Amber'],
        description: 'Lemon, cedar, and amber — Mediterranean warmth amplified. Inspired by D&G Light Blue Intense.',
        badge: 'CELEBRITY INSPIRED',
    ...
    /* ===========================================================
       ORIGINAL CREATIONS — Arabian Perfumer's signature blends
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Tobacco Oudhi original 50ml bottle with intricate Arabian art label',
        notes: ['Tobacco', 'Oud', 'Amber', 'Spicy'],
        description: 'A signature Arabian Perfumer\'s original — rich Cambodian oud entwined with aged tobacco leaf, amber resin, and warming spices. Smoky, deep, and unforgettable.',
        badge: 'ORIGINAL'
    },
    {
    ...
    /* ===========================================================
       ATTAR COLLECTION — Pure oil-based concentrated perfumes
       Starting ₹100 · Available in 3ml, 6ml, 12ml
       =========================================================== */
    {
    ...
    },
    {
        ...
        sizes: ATTAR,
        image: IMG.attarBottle,
        imageAlt: 'Arabian Perfumer\'s — Rose Taif pure attar oil',
    ...
    },
    {
        ...
        sizes: ATTAR,
        image: IMG.attarBottle,
        imageAlt: 'Arabian Perfumer\'s — Jasmine pure attar oil',
    ...
    /* ===========================================================
       SOLID PERFUME COLLECTION — Compact wax-based balm perfumes
       Starting ₹99 · Available in 8g and 15g
       =========================================================== */
    {
    ...
    /* ===========================================================
       PERSONAL CARE — Body creams, herbal soaps, crack creams
       =========================================================== */
    {
        ...
        description: 'Rich moisturising body cream infused with our signature fragrance blends. Available in multiple fragrance types. Sale ₹100 · MRP ₹280.',
        badge: 'PERSONAL CARE'
    },
    {
        id: 'mogra-body-cream',
        ...
        description: 'Luxurious body cream with the intoxicating scent of fresh Mogra (jasmine) blooms. Sale ₹100 · MRP ₹299.',
        badge: 'PERSONAL CARE'
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Handmade Herbal Soaps',
        notes: ['Herbal', 'Fresh', 'Green'],
        description: 'Grade-1 quality handmade herbal soaps with TFM 80%. Available in 10 varieties: Papaya, Charcoal, Red Sandal, Aloe Vera, Neem, Tulsi and more. ₹55 per bar.',
        badge: 'HERBAL · ₹55'
    },
    {
        id: 'crack-cream',
    ...
    /* ===========================================================
       HOME FRAGRANCE — Burners, incense, diffusers, bakhoor
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Wooden Bakhoor Burner',
        notes: ['Oud', 'Woody', 'Amber'],
        description: 'Beautifully crafted wooden bakhoor burner for incense and bakhoor. Elegant Arabian design. ₹250 per piece.',
    ...
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Jawadhu Powder 10g',
        notes: ['Oud', 'Spicy', 'Amber'],
        description: 'Traditional South Indian aromatic Jawadhu powder — a blend of precious woods, resins and spices. 10g · ₹150.',
        badge: 'HOME FRAGRANCE'
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Premium Dhoop Sticks',
    ...
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Aroma Burners',
        notes: ['Oud', 'Amber', 'Spicy'],
    ...
    },
    {
        ...
        sizes: {},
        image: IMG.bakhoorBurner,
        imageAlt: 'Arabian Perfumer\'s — Electrical Bakhoor Burner',
        notes: ['Oud', 'Amber'],
        description: 'Modern electric bakhoor burner — no flame needed. Safe and convenient for home use. Enquire on WhatsApp for pricing.',
        badge: 'ENQUIRE',
        needsVerification: true
    },
    {
        ...
        sizes: {},
        image: IMG.bakhoorBurner,
        imageAlt: 'Arabian Perfumer\'s — Non-Electric Bakhoor Burner',
    ...
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Car Hanging Perfumes',
    ...
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Reed Diffusers',
    ...
    /* ===========================================================
       BOTTLES & PACKAGING — Attar bottles, perfume bottles, gift boxes
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Display Attar Bottles',
        notes: ['Packaging'],
        description: 'Premium display attar bottle containers. Multiple models available. Sale ₹390 · MRP ₹450.',
        badge: 'PACKAGING'
    },
    {
        ...
        sizes: {},
        image: IMG.attarBottlesDisplay,
        imageAlt: 'Arabian Perfumer\'s — Golden Attar Bottles',
        notes: ['Packaging'],
    ...
    },
    {
        ...
        moq: '240 pieces',
        image: IMG.attarBottlesDisplay,
        imageAlt: 'Arabian Perfumer\'s — Wholesale Attar Bottles 6ml 12ml',
        notes: ['Packaging'],
    ...
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — 100ml Perfume Bottles',
        notes: ['Packaging'],
        description: 'Wholesale 100ml perfume bottles. MOQ 2 boxes. ₹130 per piece. Contact on WhatsApp for exact box quantities and pricing.',
        badge: 'WHOLESALE'
    },
    {
        ...
        moq: '2 boxes',
        image: IMG.perfumeBottlesWholesale,
        imageAlt: 'Arabian Perfumer\'s — 50ml Perfume Bottles',
        notes: ['Packaging'],
        description: 'Wholesale 50ml perfume bottles. MOQ 2 boxes. ₹100 per piece. Enquire on WhatsApp for bulk orders.',
        badge: 'WHOLESALE'
    },
    {
        ...
        moq: '2 boxes',
        image: IMG.perfumeBottlesWholesale,
        imageAlt: 'Arabian Perfumer\'s — 30ml Screw Neck Perfume Bottles',
        notes: ['Packaging'],
        description: 'Wholesale 30ml screw neck perfume bottles. MOQ 2 boxes. ₹90 per piece. Enquire on WhatsApp for bulk orders.',
        badge: 'WHOLESALE'
    },
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Attar Box Wholesale',
        notes: ['Packaging'],
    ...
    },
    {
        ...
        sizes: {},
        image: IMG.attarGiftPack,
        imageAlt: 'Arabian Perfumer\'s — Attar Gift Box 12ml',
        notes: ['Packaging'],
        description: 'Elegant 12ml attar gift box — ideal for gifting and special occasions. Enquire on WhatsApp for pricing.',
        badge: 'ENQUIRE',
        needsVerification: true
    },
    {
        ...
        sizes: {},
        image: IMG.attarGiftPack,
        imageAlt: 'Arabian Perfumer\'s — Attar Gift Pack 3ml 6ml 12ml',
        notes: ['Packaging'],
        description: 'Beautiful attar gift pack available in 3ml, 6ml, and 12ml sizes — perfect as a premium gift set. Enquire on WhatsApp for pricing.',
        badge: 'ENQUIRE',
        needsVerification: true
    },

    /* ===========================================================
       WHOLESALE — Raw attar materials & bulk fragrance supply
       =========================================================== */
    {
        ...
        imageAlt: 'Arabian Perfumer\'s — Wholesale Attar Raw Material',
    ...
    },
    {
        ...
        sizes: {},
        image: IMG.wholesaleAttar,
        imageAlt: 'Arabian Perfumer\'s — Wholesale Fragrance Service',
